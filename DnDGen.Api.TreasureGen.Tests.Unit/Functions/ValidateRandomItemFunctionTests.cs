...
namespace DnDGen.Api.TreasureGen.Tests.Unit.Functions
{
    public class ValidateRandomItemFunctionTests
    {
        ...
        public async Task RunV1_ReturnsTheParameterValidity(string itemType, string power, bool valid)
        {
        ...
        public async Task RunV1_ReturnsTheParameterValidity_WithName(string itemType, string power, string name, bool valid)
        {
        ...
        [TestCase("10", PowerConstants.Medium, true)]
        [TestCase("10", "bad power", false)]
        public async Task RunV2_ReturnsTheParameterValidity(string itemType, string power, bool valid)
        {
            var request = requestHelper.BuildRequest();
        ...
        [TestCase("10", PowerConstants.Mundane, WondrousItemConstants.AmuletOfHealth, false)]
        [TestCase("10", "bad power", WondrousItemConstants.AmuletOfHealth, false)]
        public async Task RunV2_ReturnsTheParameterValidity_WithName(string itemType, string power, string name, bool valid)
        {
            var query = new NameValueCollection
            {
                { "name", new StringValues(name) },
