...
namespace DnDGen.Api.TreasureGen.Tests.Unit.Functions
{
    public class ValidateRandomTreasureFunctionTests
    {
        ...
        [TestCase("Good", LevelLimits.Minimum + 1, false)]
        [TestCase("Good", LevelLimits.Maximum_Standard / 2, false)]
        [TestCase("Good", LevelLimits.Maximum_Standard - 1, false)]
        [TestCase("Good", LevelLimits.Maximum_Standard, false)]
        [TestCase("Good", LevelLimits.Maximum_Standard + 1, false)]
        [TestCase("Good", LevelLimits.Maximum_Epic / 2, false)]
        [TestCase("Good", LevelLimits.Maximum_Epic - 1, false)]
        [TestCase("Good", LevelLimits.Maximum_Epic, false)]
        [TestCase("Good", LevelLimits.Maximum_Epic + 1, false)]
        [TestCase("GOODS", LevelLimits.Minimum - 1, false)]
        [TestCase("GOODS", LevelLimits.Minimum, true)]
        [TestCase("GOODS", LevelLimits.Minimum + 1, true)]
        ...
        [TestCase("Items", LevelLimits.Maximum_Standard / 2, true)]
        [TestCase("Items", LevelLimits.Maximum_Standard - 1, true)]
        [TestCase("Items", LevelLimits.Maximum_Standard, true)]
        [TestCase("Items", LevelLimits.Maximum_Standard + 1, true)]
        [TestCase("Items", LevelLimits.Maximum_Epic / 2, true)]
        [TestCase("Items", LevelLimits.Maximum_Epic - 1, true)]
        [TestCase("Items", LevelLimits.Maximum_Epic, true)]
        [TestCase("Items", LevelLimits.Maximum_Epic + 1, true)]
        [TestCase("Item", LevelLimits.Minimum - 1, false)]
        [TestCase("Item", LevelLimits.Minimum, false)]
        [TestCase("Item", LevelLimits.Minimum + 1, false)]
        [TestCase("Item", LevelLimits.Maximum_Standard / 2, false)]
        [TestCase("Item", LevelLimits.Maximum_Standard - 1, false)]
        [TestCase("Item", LevelLimits.Maximum_Standard, false)]
        [TestCase("Item", LevelLimits.Maximum_Standard + 1, false)]
        [TestCase("Item", LevelLimits.Maximum_Epic / 2, false)]
        [TestCase("Item", LevelLimits.Maximum_Epic - 1, false)]
        [TestCase("Item", LevelLimits.Maximum_Epic, false)]
        [TestCase("Item", LevelLimits.Maximum_Epic + 1, false)]
        [TestCase("ITEMS", LevelLimits.Minimum - 1, false)]
        [TestCase("ITEMS", LevelLimits.Minimum, true)]
        [TestCase("ITEMS", LevelLimits.Minimum + 1, true)]
        ...
        [TestCase("0", LevelLimits.Maximum_Standard / 2, true)]
        [TestCase("0", LevelLimits.Maximum_Standard - 1, true)]
        [TestCase("0", LevelLimits.Maximum_Standard, true)]
        [TestCase("0", LevelLimits.Maximum_Standard + 1, true)]
        [TestCase("0", LevelLimits.Maximum_Epic / 2, true)]
        [TestCase("0", LevelLimits.Maximum_Epic - 1, true)]
        [TestCase("0", LevelLimits.Maximum_Epic, true)]
        [TestCase("0", LevelLimits.Maximum_Epic + 1, true)]
        [TestCase("1", LevelLimits.Minimum - 1, false)]
        [TestCase("1", LevelLimits.Minimum, true)]
        [TestCase("1", LevelLimits.Minimum + 1, true)]
        [TestCase("1", LevelLimits.Maximum_Standard / 2, true)]
        [TestCase("1", LevelLimits.Maximum_Standard - 1, true)]
        [TestCase("1", LevelLimits.Maximum_Standard, true)]
        [TestCase("1", LevelLimits.Maximum_Standard + 1, true)]
        [TestCase("1", LevelLimits.Maximum_Epic / 2, true)]
        [TestCase("1", LevelLimits.Maximum_Epic - 1, true)]
        [TestCase("1", LevelLimits.Maximum_Epic, true)]
        [TestCase("1", LevelLimits.Maximum_Epic + 1, true)]
        [TestCase("2", LevelLimits.Minimum - 1, false)]
        [TestCase("2", LevelLimits.Minimum, true)]
        [TestCase("2", LevelLimits.Minimum + 1, true)]
        [TestCase("2", LevelLimits.Maximum_Standard / 2, true)]
        [TestCase("2", LevelLimits.Maximum_Standard - 1, true)]
        [TestCase("2", LevelLimits.Maximum_Standard, true)]
        [TestCase("2", LevelLimits.Maximum_Standard + 1, true)]
        [TestCase("2", LevelLimits.Maximum_Epic / 2, true)]
        [TestCase("2", LevelLimits.Maximum_Epic - 1, true)]
        [TestCase("2", LevelLimits.Maximum_Epic, true)]
        [TestCase("2", LevelLimits.Maximum_Epic + 1, true)]
        [TestCase("3", LevelLimits.Minimum - 1, false)]
        [TestCase("3", LevelLimits.Minimum, true)]
        [TestCase("3", LevelLimits.Minimum + 1, true)]
        [TestCase("3", LevelLimits.Maximum_Standard / 2, true)]
        [TestCase("3", LevelLimits.Maximum_Standard - 1, true)]
        [TestCase("3", LevelLimits.Maximum_Standard, true)]
        [TestCase("3", LevelLimits.Maximum_Standard + 1, true)]
        [TestCase("3", LevelLimits.Maximum_Epic / 2, true)]
        [TestCase("3", LevelLimits.Maximum_Epic - 1, true)]
        [TestCase("3", LevelLimits.Maximum_Epic, true)]
        [TestCase("3", LevelLimits.Maximum_Epic + 1, true)]
        public async Task RunV1_ReturnsValidity(string treasureType, int level, bool valid)
        {
        ...
        [TestCase("3", LevelLimits.Maximum_Epic, true)]
        [TestCase("3", LevelLimits.Maximum_Epic + 1, true)]
        public async Task RunV2_ReturnsValidity(string treasureType, int level, bool valid)
        {
            var request = requestHelper.BuildRequest();
