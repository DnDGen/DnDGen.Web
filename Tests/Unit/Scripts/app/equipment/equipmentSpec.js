        ...
        bootstrapDataMock = {
            checkInModel: {
                MainDocument: {
                    ...
                    Status: "",
                    FileName: {
                        Base: "main document file name",
                        Extension: ".mdext",
                        Full: "full main document file name.mdext"
                    },
                    FileIconUrl: "url"
                },
                Dependencies: [
                    {
                        ...
                        Status: "",
                        FileName: {
                            Base: "dependency 1 file name",
                            Extension: ".d1ext",
                            Full: "full dependency 1 file name.d1ext"
                        },
                        FileIconUrl: "url"
                    }, {
                        Id: 90210,
                        Status: "",
                        FileName: {
                            Base: "dependency 2 file name",
                            Extension: ".d2ext",
                            Full: "full dependency 2 file name.d2ext"
                        },
                        FileIconUrl: "url"
                    }, {
                        Id: 3,
                        Status: "",
                        FileName: {
                            Base: "dependency 3 file name",
                            Extension: ".d3ext",
                            Full: "full dependency 3 file name.d3ext"
                        },
                        FileIconUrl: "url"
                    }, {
                        Id: 4,
                        Status: "",
                        FileName: {
                            Base: "dependency 4 file name",
                            Extension: ".d4ext",
                            Full: "full dependency 4 file name.d4ext"
                        },
                        FileIconUrl: "url"
                    }
                ]
