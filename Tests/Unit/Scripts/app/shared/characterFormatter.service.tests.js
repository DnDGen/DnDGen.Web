...
describe('Character Formatter Service', function () {
    ...
    it('formats full character', function () {
        ...
        expect(lines[67]).toBe("Combat:");
        expect(lines[68]).toBe("\tAdjusted Dexterity Bonus: 4");
        expect(lines[69]).toBe("\tArmor Class: 8 *");
        expect(lines[70]).toBe("\t\tFlat-Footed: 13");
        expect(lines[71]).toBe("\t\tTouch: 35");
        expect(lines[72]).toBe("\tBase Attack: +22/+17/+12/+7/+2 *");
        expect(lines[73]).toBe("\tHit Points: 3457");
        expect(lines[74]).toBe("\tInitiative Bonus: 4568");
        expect(lines[75]).toBe("\tSaving Throws:");
        expect(lines[76]).toBe("\t\tFortitude: 57");
        expect(lines[77]).toBe("\t\tReflex: 79");
        expect(lines[78]).toBe("\t\tWill: 68");
        expect(lines[79]).toBe("\t\tCircumstantial Bonus");
        expect(lines[80]).toBe('');
