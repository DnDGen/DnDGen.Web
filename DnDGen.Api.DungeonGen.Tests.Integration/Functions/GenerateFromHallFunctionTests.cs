...
{
    public class GenerateFromHallFunctionTests : IntegrationTests
    {
        private GenerateFromHallFunction function;
        ...
        public void Setup()
        {
            ...
            function = new GenerateFromHallFunction(loggerFactory, dependencyFactory);
        }
        ...
        private string GetUrl(
            ...
            string query = "")
        {
            var url = $"https://dungeon.dndgen.com/api/v1/dungeon/level/{dungeonLevel}/hall/{temperature}/{environment}/{timeOfDay}/level/{partyLevel}/generate";
            if (query.Any())
                url += "?" + query;
