...
namespace DNDGenSite.Repositories
{
    public interface IRandomizerRepository
    {
        ...
        ILevelRandomizer GetLevelRandomizer(String levelRandomizerType, Int32 setLevel);
        ...
        IStatsRandomizer GetStatsRandomizer(String statRandomizerType, Int32 setStrength, Int32 setConstitution, Int32 setDexterity, Int32 setIntelligence, Int32 setWisdom, Int32 setCharisma);
    }
}
