...
namespace DNDGenSite.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            LoadExternelModules(kernel);
            LoadInternalBindings(kernel);
        }

        private static void LoadExternelModules(IKernel kernel)
        {
        ...
        private static void LoadInternalBindings(IKernel kernel)
        {
