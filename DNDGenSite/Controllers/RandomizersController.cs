...
namespace DNDGenSite.Controllers
{
    public class RandomizersController : Controller
    {
        ...
        [HttpGet]
        public JsonResult Verify(String alignmentRandomizerType, String classNameRandomizerType, String levelRandomizerType, String baseRaceRandomizerType, String metaraceRandomizerType, String setAlignment = "", String setClassName = "", Int32 setLevel = 0, String setBaseRace = "", Boolean forceMetarace = false, String setMetarace = "")
        {
