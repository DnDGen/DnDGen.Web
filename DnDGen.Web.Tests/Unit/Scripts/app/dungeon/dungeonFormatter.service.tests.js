...
describe('Dungeon Formatter Service', function () {
    ...
    it('formats areas', function () {
        ...
        var expected = [
            ...
            '\t\t\t\tformatted treasure',
            '\t\t\t\t\tgold 1',
            '\t\t\t\t\tGood: goods description 1',
            '\t\t\t\t\tItem: item 1 formatted',
            '\t\t\tTreasure 2:',
            '\t\t\t\tContainer: container 2',
            '\t\t\t\tConcealment: concealment 2',
            '\t\t\t\tformatted treasure',
            '\t\t\t\t\tgold 2',
            '\t\t\t\t\tGood: goods description 2',
            '\t\t\t\t\tItem: item 2 formatted',
            '\t\tPool:',
            '\t\t\tEncounter:',
            '\t\t\t\tformatted encounter',
            '\t\t\t\t\tcreature: monster 3',
            ...
            '\t\t\t\tformatted treasure',
            '\t\t\t\t\tgold 3',
            '\t\t\t\t\tGood: goods description 3',
            '\t\t\t\t\tItem: item 3 formatted',
    ...
    it('formats pool with coin', function () {
        areas[0].Contents.Pool.Treasure.Treasure.Goods = [];
    ...
    it('formats pool with goods', function () {
    ...
    it('formats pool with items', function () {
        areas[0].Contents.Pool.Treasure.Treasure.Goods = [];
        areas[0].Contents.Pool.Treasure.Treasure.Coin.Quantity = 0;
    ...
    it('formats empty treasure', function () {
        areas[0].Contents.Treasures[0].Treasure.Coin.Quantity = 0;
        areas[0].Contents.Treasures[0].Treasure.Goods = [];
