...
{
    public class GetCharacterViewModelFunctionTests : IntegrationTests
    {
        ...
        public void Setup()
        {
            ...
            function = new GetCharacterViewModelFunction(loggerFactory);
        }

        [Test]
        public async Task Run_ReturnsCharacterViewModel()
        {
            var url = GetUrl();
