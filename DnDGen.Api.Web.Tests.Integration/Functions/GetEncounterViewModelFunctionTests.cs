...
{
    public class GetEncounterViewModelFunctionTests : IntegrationTests
    {
        ...
        public void Setup()
        {
            ...
            function = new GetEncounterViewModelFunction(loggerFactory);
        }

        [Test]
        public async Task Run_ReturnsEncounterViewModel()
        {
            var url = GetUrl();
