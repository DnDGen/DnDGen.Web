...
{
    internal class GenerateFromDoorFunctionTests
    {
        private GenerateFromDoorFunction _function;
        private Mock<IEncounterVerifier> mockEncounterVerifier;
        private Mock<IDungeonGenerator> mockDungeonGenerator;
        private Mock<ILogger<GenerateFromDoorFunction>> mockLogger;
        ...
        public void Setup()
        {
            ...
            mockLogger = new Mock<ILogger<GenerateFromDoorFunction>>();
            ...
            mockLoggerFactory.Setup(f => f.CreateLogger("DnDGen.Api.DungeonGen.Functions.GenerateFromDoorFunction")).Returns(mockLogger.Object);
            ...
            _function = new GenerateFromDoorFunction(mockLoggerFactory.Object, mockDependencyFactory.Object);
        ...
        public async Task Run_ReturnsTheDungeonAreas()
        {
            ...
            mockDungeonGenerator
                .Setup(v => v.GenerateFromDoor(9266, It.Is<EncounterSpecifications>(s =>
                    s.Description == "Level 1 Temperate Plains Day")))
        ...
        [Test]
        public async Task BUG_GenerateFromDoor_WithWeaponV1()
        {
            mockEncounterVerifier
                .Setup(v => v.ValidEncounterExists(It.Is<EncounterSpecifications>(s =>
                    s.Description == "Level 1 Temperate Plains Day")))
