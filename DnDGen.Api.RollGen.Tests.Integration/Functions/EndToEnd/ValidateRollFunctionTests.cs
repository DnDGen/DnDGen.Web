...
namespace DnDGen.Api.RollGen.Tests.Integration.Functions.EndToEnd
{
    public class ValidateRollFunctionTests : EndToEndTests
    {
        ...
        [TestCase("/api/v1/roll/validate", 3, 6, true)]
        [TestCase("/api/v1/Roll/Validate", 3, 6, true)]
        [TestCase("/api/v1/roll/validate", 42, 600, true)]
        [TestCase("/api/v1/roll/validate", 10_000, 1, true)]
        [TestCase("/api/v1/roll/validate", 10_001, 1, false)]
        [TestCase("/api/v1/roll/validate", 16_500_000, 1, false)]
        [TestCase("/api/v1/roll/validate", 16_500_001, 1, false)]
        [TestCase("/api/v1/roll/validate", 1, 10_000, true)]
        [TestCase("/api/v1/roll/validate", 1, 10_001, false)]
        [TestCase("/api/v1/roll/validate", 1, 16_500_000, false)]
        [TestCase("/api/v1/roll/validate", 1, 16_500_001, false)]
        [TestCase("/api/v1/roll/validate", 1, int.MaxValue, false)]
        [TestCase("/api/v1/roll/validate", 2, int.MaxValue, false)]
        [TestCase("/api/v1/roll/validate", 10_000, 10_000, true)]
        [TestCase("/api/v1/roll/validate", 10_001, 10_000, false)]
        [TestCase("/api/v1/roll/validate", 10_000, 10_001, false)]
        [TestCase("/api/v1/roll/validate", 10_001, 10_001, false)]
